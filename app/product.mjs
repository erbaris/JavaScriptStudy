import {writeLine} from "../util/console.mjs"
...
let createRandomProducts = (count) =>  {
    let products = []
    while(count--) {
        products.push(new Product(randomInt(0, 1000), stringUtil.randomTextEN(randomInt(0, 20)), randomInt(0, 2) - 1 ? randomInt(0, 1000) : 0, randomInt(0, 10_000), randomInt(10_000, 100_000)));
    }
    return products
}
